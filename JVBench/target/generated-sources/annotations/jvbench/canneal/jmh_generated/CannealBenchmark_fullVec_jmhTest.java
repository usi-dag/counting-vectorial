...
public final class CannealBenchmark_fullVec_jmhTest {
    ...
    public BenchmarkTaskResult fullVec_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_cannealbenchmark0_0.fullVec(l_mystate1_1, blackhole, l_jmhbenchmarkconfig2_G);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            fullVec_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_mystate1_1, l_jmhbenchmarkconfig2_G, l_cannealbenchmark0_0);
    ...
    public BenchmarkTaskResult fullVec_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            fullVec_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_mystate1_1, l_jmhbenchmarkconfig2_G, l_cannealbenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult fullVec_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            fullVec_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_mystate1_1, l_jmhbenchmarkconfig2_G, l_cannealbenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult fullVec_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            fullVec_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_mystate1_1, l_jmhbenchmarkconfig2_G, l_cannealbenchmark0_0);
            control.preTearDown();
            if (JMHBenchmarkConfig_jmhType.tearIterationMutexUpdater.compareAndSet(l_jmhbenchmarkconfig2_G, 0, 1)) {
                try {
                    if (control.isFailing) throw new FailureAssistException();

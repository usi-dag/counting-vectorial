...
public final class CannealBenchmark_explicitVec_jmhTest {
    ...
    public BenchmarkTaskResult explicitVec_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_cannealbenchmark0_0.explicitVec(l_mystate1_1, blackhole, l_jmhbenchmarkconfig2_G);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            explicitVec_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_mystate1_1, l_jmhbenchmarkconfig2_G, l_cannealbenchmark0_0);
    ...
    public BenchmarkTaskResult explicitVec_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            explicitVec_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_mystate1_1, l_jmhbenchmarkconfig2_G, l_cannealbenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult explicitVec_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            explicitVec_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_mystate1_1, l_jmhbenchmarkconfig2_G, l_cannealbenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult explicitVec_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            explicitVec_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_mystate1_1, l_jmhbenchmarkconfig2_G, l_cannealbenchmark0_0);
            control.preTearDown();
            if (JMHBenchmarkConfig_jmhType.tearIterationMutexUpdater.compareAndSet(l_jmhbenchmarkconfig2_G, 0, 1)) {
                try {
                    if (control.isFailing) throw new FailureAssistException();
    ...
    CannealBenchmark_jmhType _jmh_tryInit_f_cannealbenchmark0_0(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        CannealBenchmark_jmhType val = f_cannealbenchmark0_0;
        if (val == null) {
            val = new CannealBenchmark_jmhType();
            f_cannealbenchmark0_0 = val;
        }
        return val;
    }
    
    CannealBenchmark_MyState_jmhType f_mystate1_1;
    
    CannealBenchmark_MyState_jmhType _jmh_tryInit_f_mystate1_1(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        CannealBenchmark_MyState_jmhType val = f_mystate1_1;
        if (val == null) {
            val = new CannealBenchmark_MyState_jmhType();
            val.setup();
            f_mystate1_1 = val;
        }
        return val;

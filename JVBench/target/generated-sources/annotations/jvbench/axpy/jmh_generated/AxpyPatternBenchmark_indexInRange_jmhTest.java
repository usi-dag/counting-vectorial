...
public final class AxpyPatternBenchmark_indexInRange_jmhTest {
    ...
    public BenchmarkTaskResult indexInRange_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_axpypatternbenchmark0_0.indexInRange(l_mystate1_1, blackhole, l_socketplugin2_G);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            indexInRange_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_mystate1_1, l_socketplugin2_G, l_axpypatternbenchmark0_0);
    ...
    public BenchmarkTaskResult indexInRange_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            indexInRange_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_mystate1_1, l_socketplugin2_G, l_axpypatternbenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult indexInRange_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            indexInRange_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_mystate1_1, l_socketplugin2_G, l_axpypatternbenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult indexInRange_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            indexInRange_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_mystate1_1, l_socketplugin2_G, l_axpypatternbenchmark0_0);
            control.preTearDown();
            l_mystate1_1.reset();
            if (AxpyPatternBenchmark_SocketPlugin_jmhType.tearIterationMutexUpdater.compareAndSet(l_socketplugin2_G, 0, 1)) {
                try {
